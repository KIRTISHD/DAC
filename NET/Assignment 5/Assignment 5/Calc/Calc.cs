...
namespace Assignment_5.Calc
{
    class Calc
    {
        static void Main(string[] args)
        {
            ...
            {
                case "+":
                    Console.WriteLine("Addition of two numbers is->" + cc.GetSum(x, y));
                    break;
                case "-":
                    Console.WriteLine("Subtraction of two numbers is->" + cc.GetSubtract(x, y));
                    break;
                case "*":
                    if (y == 0 || x == 0)
                    {
                    ...
                    Console.WriteLine("Multiplication of two numbers is->" + cc.GetMultiply(x, y));
                    break;
                case "/":
                    if (y == 0)
                    {
                    ...
                    Console.WriteLine("Division of two numbers is->" + cc.GetDivide(x, y));
                    break;
                default:
